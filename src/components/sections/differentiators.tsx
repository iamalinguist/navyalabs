...
export function Differentiators() {
    return (
        <section id="why-us" className="py-16 sm:py-24 bg-muted">
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
                    {differentiators.map((item) => (
                        <div key={item.title} className="flex flex-col items-center text-center gap-4 p-6 bg-card rounded-lg transition-all duration-300 hover:bg-accent hover:shadow-lg border">
